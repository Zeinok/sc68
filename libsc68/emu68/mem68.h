...
static inline uint68_t _read_B(emu68_t * const emu68, addr68_t addr)
{
  emu68->bus_addr = addr;
  mem68_read_b(emu68);
...
static inline uint68_t _read_W(emu68_t * const emu68, addr68_t addr)
{
  emu68->bus_addr = addr;
  mem68_read_w(emu68);
...
static inline uint68_t _read_L(emu68_t * const emu68, addr68_t addr)
{
  emu68->bus_addr = addr;
  mem68_read_l(emu68);
...
static inline void _write_B(emu68_t * const emu68, addr68_t addr, int68_t v)
{
  emu68->bus_addr = addr;
  emu68->bus_data = v;
  mem68_write_b(emu68);
