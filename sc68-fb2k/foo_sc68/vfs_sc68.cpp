...
/** vfs file structure. */
struct vfs68_fb2k {
	vfs68_fb2k(service_ptr_t<file> p_file, const char * p_path, t_input_open_reason p_reason, abort_callback & p_abort);
	~vfs68_fb2k();
...
vfs68_fb2k::vfs68_fb2k(service_ptr_t<foobar2000_io::file> p_file, const char * p_path,
