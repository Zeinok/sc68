...
;
; Time-stamp: <2013-12-22 13:43:32 ben>
;
...
aSIDvoicify:
	...
	movem.w	ym_cyr(a6),d2-d5 ; cyr,cyr2,crs,cr2
    	...
    	add	d4,d2		; d2: angle 1
	add	d5,d3		; d3: angle 2
	...
	moveq	#0,d4
	move.b	0(a5,d3.w),d4	; 16-240
	sub.w	#128,d4		; -112-112
	add	d4,d4		; -224-224
	movem.w	d4-d5,ym_crs(a6)

	moveq	#0,d4
	move.b	0(a5,d2.w),d4	; cyclic ratio #1 [16..240]

	;; lsr	#16-9,d3
	;; moveq	#0,d5
	;; move.b	0(a5,d3.w),d5	; cyclic ratio #2 [16..240]
	...
	;; add	d4,d4
	;; add	d4,d5
	;; lsr	#2,d5		; final cyclic ratio [16..240]
