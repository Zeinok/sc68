/*
 * @file    as68,h
 * @brief   68000 macro assembler - definitions
...
typedef struct fast_table {
  struct fast_table * letter[FAST_LETTERS];
  void (*function)();
  int value;
} fast_table_t;

extern fast_table_t * opcode_table[FAST_LETTERS];
extern fast_table_t * register_table[FAST_LETTERS];
